...
namespace MarsRover.Data
{
    ...
    {
        public Location DefineLocation(string Position) // ilk alınan datada lokasyonu ve yönü splitleriz
        {
        ...
        public Rectangle DefineRectangle(string Dimension) // ilk alınan datada dikdörtgen boyutunu splitleriz
        {
        ...
        {
            array = param.Split(' '); // Gelen datalarda hep boşluklu string verildiği için bu şekilde yazılıp ayrılması daha mantıklı.
        }
    }
}
